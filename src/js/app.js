...
/**
 * Clase principal para manejar notificaciones tipo toast.
 *
 * @class MiniToast
 * @description Una librería ligera para mostrar mensajes emergentes (toasts) con estilos personalizables.
 * Soporta variantes como success, error, warning e info, con opciones de configuración para posición,
 * duración, íconos y más. Requiere un elemento contenedor en el DOM para funcionar.
 *
 * @example
 ...
 *   vertical: "top"
 * });
 * toast.success({ title: "Éxito", message: "Operación completada" });
 */
class MiniToast {
